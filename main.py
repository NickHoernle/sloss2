...
class DecoderModel(nn.Module):
    def __init__(self, num_classes, z_dim=2):
        ...
        self.mu = nn.Sequential(nn.Linear(num_classes, 50), nn.LeakyReLU(.2), nn.Linear(50, 50), nn.LeakyReLU(.2), nn.Linear(50, z_dim))
        self.logvar = nn.Sequential(nn.Linear(num_classes, 50),nn.LeakyReLU(.2), nn.Linear(50, 50), nn.LeakyReLU(.2), nn.Linear(50, z_dim))
